...
BEGIN
    ...
    -- v_setlst('EMCS_NUM_COMPONENTS') := '15';
    -- v_setlst('CLUS_NUM_CLUSTERS') := '5';
    -- v_setlst('EMCS_CLUSTER_COMP_ENABLE') := 'EMCS_CLUSTER_COMP_DISABLE';
    -- v_setlst('EMCS_ATTRIBUTE_FILTER') := 'EMCS_ATTR_FILTER_DISABLE';
    -- v_setlst('EMCS_LINKAGE_FUNCTION') := 'EMCS_LINKAGE_AVERAGE';
