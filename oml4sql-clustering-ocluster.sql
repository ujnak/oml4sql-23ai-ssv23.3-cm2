...
BEGIN
  ...
  dbms_data_mining_transform.SET_TRANSFORM(
    xformlist, 'SOCCER', null, 'TO_CHAR(SOCCER)', null);
  dbms_data_mining_transform.SET_TRANSFORM(
    xformlist, 'CRICKET', null, 'TO_CHAR(CRICKET)', null);
  dbms_data_mining_transform.SET_TRANSFORM(
    xformlist, 'BASEBALL', null, 'TO_CHAR(BASEBALL)', null);
  dbms_data_mining_transform.SET_TRANSFORM(
    xformlist, 'TENNIS', null, 'TO_CHAR(TENNIS)', null);
  dbms_data_mining_transform.SET_TRANSFORM(
    xformlist, 'MISC', null, 'TO_CHAR(MISC)', null);
  dbms_data_mining_transform.SET_TRANSFORM(
    xformlist, 'GOLF', null, 'TO_CHAR(GOLF)', null);
  dbms_data_mining_transform.SET_TRANSFORM(
    xformlist, 'UNKNOWN', null, 'TO_CHAR(UNKNOWN)', null);

  -- Set algorithm to O-Cluster
