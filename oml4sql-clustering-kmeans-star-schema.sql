...
-- 
--   Clustering - K-Means Algorithm - dmstardemo.sql (Modified to use CREATE_MODEL2)
--   
...
begin
  ...
  -- Set up model settings using SETTING_LIST
  v_setlst('PREP_AUTO') := 'ON';
  v_setlst('KMNS_DETAILS') := 'KMNS_DETAILS_ALL';

  -- perform the build using CREATE_MODEL2
