...
--   Modified to use DBMS_DATA_MINING.CREATE_MODEL2
--   
...
----------------------------------------------
-- Build AR model with transactional input using CREATE_MODEL2
--
DECLARE
...
-- Build AR model with 2-column transactional input using CREATE_MODEL2
--
DECLARE
    v_setlst DBMS_DATA_MINING.SETTING_LIST;
BEGIN
